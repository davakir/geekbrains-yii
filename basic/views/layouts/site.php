...
<html lang="<?= Yii::$app->language ?>">
	<head>
		...
		<link rel="icon" type="image/x-icon" href="<?= $srcPath . '/img/favicon.ico' ?>"/>
		
		<?php $this->registerCssFile('vendor/font-awesome-4.7.0/css/font-awesome.min.css') ?>
